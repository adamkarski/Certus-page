...
>
    ...
    <div class="relative menubar">
      <div class="flex items-center px-8 py-4 contenerNav">
        ...
        <div class="menu-wrapper">
          <div class="items-center space-x-1 menuItems">
            <!-- Maszyny z dropdown -->
            <div
  ...
  {#if isMobileMenuOpen}
    <div class="mobile-menu-overlay" transition:fade>
      <div class="mobile-menu-content" transition:fly={{ x: -200, duration: 500 }}>
        <a href="/maszyny" on:click={toggleMobileMenu}>Maszyny</a>
        <a href="/serwis" on:click={toggleMobileMenu}>Serwis</a>
        <a href="/onas" on:click={toggleMobileMenu}>O nas</a>
        <a href="/kontakt" on:click={toggleMobileMenu}>Kontakt</a>
      </div>
    </div>
  {/if}
</nav>
